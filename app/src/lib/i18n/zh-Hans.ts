...
export const zhHans: Messages = {
  ...
  library: {
    title: "笔记库",
    newNoteTitle: (date: string): string => `笔记 · ${date}`,
    searchPlaceholder: "搜索笔记…",
    empty: "还没有笔记。结束的会话会自动保存到这里。",
    noResults: "没有匹配的结果。",
    searching: "搜索中…",
    searchBy: "搜索方式",
    searchModeHint: "可在 设置 → 笔记搜索 调整",
    matchKeyword: "关键字匹配",
    matchSemantic: "语义匹配",
    matchHybrid: "混合(关键字＋语义)",
    back: "返回",
    delete: "删除",
    cancel: "取消",
    deleteTitle: "删除笔记",
  ...
  settings: {
    ...
    embedBgHint: "在后台进行 —— 可继续其他操作。",
    embedWorking: "处理中…",
    embedApi: "API",
    embedNeedsKey: "需要 API 密钥",
    embedKeyLabel: (name: string): string => `${name} API 密钥`,
    embedKeyPlaceholder: "粘贴你的 API 密钥",
    embedKeySave: "保存",
    embedImportHint:
